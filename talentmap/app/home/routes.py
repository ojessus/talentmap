...
def index():
    ...
    elif current_user.username == 'gpKiaCd :
        return render_template('PermanenciagpKiaCd .html', segment='PermanenciagpKiaCd )
    ...
    elif current_user.username == 'gpKiaLa :
        return render_template('PermanenciagpKiaLa .html', segment='PermanenciagpKiaLa )
